...
abstract contract BancorFormula {
    ...
    function _generalLog(uint256 x) internal pure returns (uint256 result) {
        ...
        if (x > FIXED_1) {
            for (uint8 i = MAX_PRECISION; i > 0; --i) {
                ...
                if (x >= FIXED_2) {
                    // Divide x by 2 to get it back in the 1 to 2 range
                    x >>= 1; // now 1 < x < 2
        ...
        // Times result by natural logarithm of 2 to convert log base 2 to natural logarithm (log base e)
    ...
    function _optimalLog(uint256 x) internal pure returns (uint256 result) {
        ...
        if (x >= 0x910b022db7ae67ce76b441c27035c6a1) {
            result += 0x10000000000000000000000000000000;
            x = x * FIXED_1 / 0x910b022db7ae67ce76b441c27035c6a1;
        } // add 1 / 2^3
        if (x >= 0x88415abbe9a76bead8d00cf112e4d4a8) {
            result += 0x08000000000000000000000000000000;
            x = x * FIXED_1 / 0x88415abbe9a76bead8d00cf112e4d4a8;
        } // add 1 / 2^4
        if (x >= 0x84102b00893f64c705e841d5d4064bd3) {
            result += 0x04000000000000000000000000000000;
            x = x * FIXED_1 / 0x84102b00893f64c705e841d5d4064bd3;
        } // add 1 / 2^5
        if (x >= 0x8204055aaef1c8bd5c3259f4822735a2) {
            result += 0x02000000000000000000000000000000;
            x = x * FIXED_1 / 0x8204055aaef1c8bd5c3259f4822735a2;
        } // add 1 / 2^6
        if (x >= 0x810100ab00222d861931c15e39b44e99) {
            result += 0x01000000000000000000000000000000;
            x = x * FIXED_1 / 0x810100ab00222d861931c15e39b44e99;
        } // add 1 / 2^7
        if (x >= 0x808040155aabbbe9451521693554f733) {
            result += 0x00800000000000000000000000000000;
            x = x * FIXED_1 / 0x808040155aabbbe9451521693554f733;
        } // add 1 / 2^8

        // Iterate through the Taylor series to increase accuracy
        z = y = x - FIXED_1;
        w = y * y / FIXED_1;
        result += z * (0x100000000000000000000000000000000 - y) / 0x100000000000000000000000000000000;
        z = z * w / FIXED_1; // add y^01 / 01 - y^02 / 02
        result += z * (0x0aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa - y) / 0x200000000000000000000000000000000;
        z = z * w / FIXED_1; // add y^03 / 03 - y^04 / 04
        result += z * (0x099999999999999999999999999999999 - y) / 0x300000000000000000000000000000000;
        z = z * w / FIXED_1; // add y^05 / 05 - y^06 / 06
        result += z * (0x092492492492492492492492492492492 - y) / 0x400000000000000000000000000000000;
        z = z * w / FIXED_1; // add y^07 / 07 - y^08 / 08
        result += z * (0x08e38e38e38e38e38e38e38e38e38e38e - y) / 0x500000000000000000000000000000000;
        z = z * w / FIXED_1; // add y^09 / 09 - y^10 / 10
        result += z * (0x08ba2e8ba2e8ba2e8ba2e8ba2e8ba2e8b - y) / 0x600000000000000000000000000000000;
        z = z * w / FIXED_1; // add y^11 / 11 - y^12 / 12
        result += z * (0x089d89d89d89d89d89d89d89d89d89d89 - y) / 0x700000000000000000000000000000000;
        z = z * w / FIXED_1; // add y^13 / 13 - y^14 / 14
        result += z * (0x088888888888888888888888888888888 - y) / 0x800000000000000000000000000000000; // add y^15 / 15 - y^16 / 16
    ...
    function _optimalExp(uint256 x) internal pure returns (uint256 result) {
        ...
        // Reduce value for efficiency
        z = y = x % 0x10000000000000000000000000000000; // get the input modulo 2^(-3)
        // y^02 scaled for precision
        z = z * y / FIXED_1;

        // Iterate through the Taylor series to increase accuracy
        result += z * 0x10e1b3be415a0000; // add y^02 * (20! / 02!)
        z = z * y / FIXED_1;
        result += z * 0x05a0913f6b1e0000; // add y^03 * (20! / 03!)
        z = z * y / FIXED_1;
        result += z * 0x0168244fdac78000; // add y^04 * (20! / 04!)
        z = z * y / FIXED_1;
        result += z * 0x004807432bc18000; // add y^05 * (20! / 05!)
        z = z * y / FIXED_1;
        result += z * 0x000c0135dca04000; // add y^06 * (20! / 06!)
        z = z * y / FIXED_1;
        result += z * 0x0001b707b1cdc000; // add y^07 * (20! / 07!)
        z = z * y / FIXED_1;
        result += z * 0x000036e0f639b800; // add y^08 * (20! / 08!)
        z = z * y / FIXED_1;
        result += z * 0x00000618fee9f800; // add y^09 * (20! / 09!)
        z = z * y / FIXED_1;
        result += z * 0x0000009c197dcc00; // add y^10 * (20! / 10!)
        z = z * y / FIXED_1;
        result += z * 0x0000000e30dce400; // add y^11 * (20! / 11!)
        z = z * y / FIXED_1;
        result += z * 0x000000012ebd1300; // add y^12 * (20! / 12!)
        z = z * y / FIXED_1;
        result += z * 0x0000000017499f00; // add y^13 * (20! / 13!)
        z = z * y / FIXED_1;
        result += z * 0x0000000001a9d480; // add y^14 * (20! / 14!)
        z = z * y / FIXED_1;
        result += z * 0x00000000001c6380; // add y^15 * (20! / 15!)
        z = z * y / FIXED_1;
        result += z * 0x000000000001c638; // add y^16 * (20! / 16!)
        z = z * y / FIXED_1;
        result += z * 0x0000000000001ab8; // add y^17 * (20! / 17!)
        z = z * y / FIXED_1;
        result += z * 0x000000000000017c; // add y^18 * (20! / 18!)
        z = z * y / FIXED_1;
        result += z * 0x0000000000000014; // add y^19 * (20! / 19!)
        z = z * y / FIXED_1;
        result += z * 0x0000000000000001; // add y^20 * (20! / 20!)
        ...
        if ((x & 0x020000000000000000000000000000000) != 0) {
            result = result * 0x18ebef9eac820ae8682b9793ac6d1e778 / 0x1368b2fc6f9609fe7aceb46aa619baed4;
        } // multiply by e^2^(-2)
        if ((x & 0x040000000000000000000000000000000) != 0) {
            result = result * 0x1368b2fc6f9609fe7aceb46aa619baed5 / 0x0bc5ab1b16779be3575bd8f0520a9f21f;
        } // multiply by e^2^(-1)
        if ((x & 0x080000000000000000000000000000000) != 0) {
            result = result * 0x0bc5ab1b16779be3575bd8f0520a9f21e / 0x0454aaa8efe072e7f6ddbab84b40a55c9;
        } // multiply by e^2^(+0)
        if ((x & 0x100000000000000000000000000000000) != 0) {
            result = result * 0x0454aaa8efe072e7f6ddbab84b40a55c5 / 0x00960aadc109e7a3bf4578099615711ea;
        } // multiply by e^2^(+1)
        if ((x & 0x200000000000000000000000000000000) != 0) {
            result = result * 0x00960aadc109e7a3bf4578099615711d7 / 0x0002bf84208204f5977f9a8cf01fdce3d;
        } // multiply by e^2^(+2)
        if ((x & 0x400000000000000000000000000000000) != 0) {
            result = result * 0x0002bf84208204f5977f9a8cf01fdc307 / 0x0000003c6ab775dd0b95b4cbee7e65d11;
        } // multiply by e^2^(+3)
